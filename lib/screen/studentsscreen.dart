...
class _StudentScreenState extends State<StudentScreen> {
  ...
  Future<void> _fetchClasses() async {
    try {
      ...
      setState(() {
        ...
        _selectedClassId =
            classes.isNotEmpty ? classes[0]['codClass'].toString() : null;
  ...
  Future<void> _fetchStudents() async {
    if (_selectedClassId == null)
      return; // Ne fait rien si aucune classe sélectionnée
    try {
  ...
  void _showEditStudentDialog(Student student) {
    showDialog(
      ...
      builder: (BuildContext context) {
        return AddStudentDialog(
          notifyParent:
              _fetchStudents, // Rafraîchir la liste après modification
          student: student,
        );
      },
    );
                ...
                : ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return ListTile(
                        ...
                        onTap: () => _showEditStudentDialog(Student.fromJson(
                            student)), // Ouvrir le formulaire d'édition
                      );
                    },
                  ),
          ),
